...
var $author$project$TwoFer$twoFer = function (name) {
	if (name.$ === 'Nothing') {
		...
		var name_ = name.a;
		return 'One for ' + (name_ + ', one for me.');
	}
};
...
var $author$project$Test$Generated$Main1068744438$main = A2(
	$author$project$Test$Runner$Node$run,
	{
		paths: _List_fromArray(
			['/Users/rkhalil/Exercism/elm/two-fer/tests/Tests.elm']),
		processes: 16,
...
_Platform_export({'Test':{'Generated':{'Main1068744438':{'init':$author$project$Test$Generated$Main1068744438$main($elm$json$Json$Decode$int)(0)}}}});}(this));
return this.Elm;
})({});
var pipeFilename = "/tmp/elm_test-28756.sock";
