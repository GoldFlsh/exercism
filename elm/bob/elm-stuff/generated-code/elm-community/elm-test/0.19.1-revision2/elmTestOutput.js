...
var $author$project$Tests$character = F2(
	function (start, end) {
		return A2(
...
var $author$project$Tests$anyCharacter = A2($author$project$Tests$character, 32, 126);
...
var $author$project$Tests$listOfCharacters = F2(
	function (length, characterList) {
		return A2($elm$random$Random$list, length, characterList);
	});
var $author$project$Tests$gibberish = F2(
	function (length, characterList) {
		return A2(
			$elm$random$Random$step,
			A2(
				...
				A2($author$project$Tests$listOfCharacters, length, characterList)),
			$elm$random$Random$initialSeed(424242)).a;
	});
...
var $author$project$Bob$containsAlpha = function (remark) {
	return A2($elm$core$String$any, $elm$core$Char$isAlpha, remark);
};
var $elm$core$String$toUpper = _String_toUpper;
var $author$project$Bob$isLoud = function (remark) {
	return _Utils_eq(
		$elm$core$String$toUpper(remark),
		remark) && $author$project$Bob$containsAlpha(remark);
};
var $elm$core$String$endsWith = _String_endsWith;
var $author$project$Bob$isQuestion = function (remark) {
	return A2($elm$core$String$endsWith, '?', remark);
};
var $author$project$Bob$hey = function (remark) {
	return ($author$project$Bob$isLoud(remark) && $author$project$Bob$isQuestion(remark)) ? 'Calm down, I know what I\'m doing!' : ($author$project$Bob$isLoud(remark) ? 'Whoa, chill out!' : ($author$project$Bob$isQuestion(
		$elm$core$String$trim(remark)) ? 'Sure.' : (($elm$core$String$trim(remark) === '') ? 'Fine. Be that way!' : 'Whatever.')));
};
...
var $author$project$Tests$uppercaseCharacter = A2($author$project$Tests$character, 65, 90);
var $author$project$Tests$uppercaseGibberish = function (length) {
	return A2($author$project$Tests$gibberish, length, $author$project$Tests$uppercaseCharacter);
};
...
var $author$project$Test$Generated$Main3328467605$main = A2(
	$author$project$Test$Runner$Node$run,
	{
		paths: _List_fromArray(
			['/Users/rkhalil/Exercism/elm/bob/tests/Tests.elm']),
		processes: 16,
		report: $author$project$Test$Reporter$Reporter$ConsoleReport($author$project$Console$Text$UseColor),
		runs: $elm$core$Maybe$Nothing,
		seed: 233353160076788
	},
...
_Platform_export({'Test':{'Generated':{'Main3328467605':{'init':$author$project$Test$Generated$Main3328467605$main($elm$json$Json$Decode$int)(0)}}}});}(this));
return this.Elm;
})({});
var pipeFilename = "/tmp/elm_test-41950.sock";
